...
export default defineMessages({
  ...
  whoContent: {
    id: `${scope}.whoContent`,
    defaultMessage:
      "Children from ages 8 to 13 can register for the camp. {tag} We are also looking for volunteers (age 14+) and volunteer counselors (age 16+) to assist with running the camp (see below).",
  },
  when: {
    id: `${scope}.when`,
    defaultMessage: "When",
  ...
  whereContent: {
    ...
    defaultMessage: "{link}, 45 minutes from downtown Ottawa",
  },
  cost: {
    id: `${scope}.cost`,
    defaultMessage: "Cost",
  ...
  costContent: {
    ...
    defaultMessage: "Displaced children by war in Ukraine: FREE.",
  },
  programming: {
  ...
  programmingContent: {
    ...
    defaultMessage:
      "Campers will take part in many indoor and outdoor activities. Programming will have a focus on Ukrainian culture. The main language of the camp will be Ukrainian, and staff and volunteers will be able to assist with interpretation when needed.",
  },
  campActivitiesTitle: {
  ...
  finalDayAtCampContent: {
    ...
    defaultMessage:
      "On the final day of camp – Sunday, July 24 – campers’ friends and family will be invited to a brief performance and closing where campers will showcase songs, dances, and other things they have learned throughout the week. More details about this final day will become available closer to the camp dates.",
  },
  ...
  registrationContent: {
    ...
    defaultMessage:
      "To register your child(ren) for Soniashnyk Summer Camp, send an email to {email} with your child(ren)’s age(s) and name(s). We will confirm receipt of your intention to register and send you a registration package to complete and return.",
  },
  callForVolunteers: {
  ...
  callForVolunteersContent: {
    ...
    defaultMessage:
      "We are also looking for volunteers and volunteer counselors to help prepare and run Soniashnyk Summer Camp.",
  },
  volunteers: {
    id: `${scope}.volunteers`,
  ...
  volunteersContent: {
    ...
    defaultMessage:
      "We are seeking volunteers of all ages (14 and above). We can validate volunteer hours for high school volunteer requirements.",
  },
  duties: {
    id: `${scope}.duties`,
  ...
  dutiesContent: {
    ...
    defaultMessage:
      "A range of volunteer positions are available, such as assisting with campers, programming, meal preparation, and camp set-up and take-down. We will also need volunteers to help with some general refresh and repairs at the camp site prior to July 17.",
  },
  becomeAVolunteer: {
  ...
  becomeAVolunteerContent: {
    ...
    defaultMessage:
      "If you are interested in sharing your skills at Soniashnyk Summer Camp, please send your interest to {link}. We will work together to find a volunteer position that works for you.",
  },
  becomeAVolunteerNote: {
    id: `${scope}.becomeAVolunteerNote`,
    defaultMessage:
      "NOTE: At this time, we are especially looking for volunteers with lifeguard and/or medical certifications (e.g., CPR; nursing). Contact us if you may be able to help in either of these ways.",
  },
  volunteerCounselor: {
  ...
  volunteerCounselorContent: {
    ...
    defaultMessage:
      "Volunteer counselors are in charge of a group of campers throughout the week. They are responsible, kind, and work well with children. They are the main points of contact for campers and accompany campers throughout all camp activities, including mealtimes and staying in the dormitories overnight.",
  },
  ...
  positionRequirements_7: {
    ...
    defaultMessage:
      "Experience organizing indoor and outdoor games/activities an asset",
  },
  apply: {
    id: `${scope}.apply`,
  ...
  applyContent: {
    ...
    defaultMessage:
      "If you are interested in applying for a volunteer counselor position, please send an email, including a copy of your resume, to {email}.",
  },
  bulletPointsTitle: {
  ...
  help_needed: {
    ...
    defaultMessage:
      "We are now looking for a lifeguard, a psychologist and a nurse.",
  },
  certificates: {
