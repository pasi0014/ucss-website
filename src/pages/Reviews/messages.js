...
export default defineMessages({
  ...
  title_bazar: {
    ...
    defaultMessage:
      "Ukrainian Easter Bazar at the St. John the Baptist Ukrainian Catholic Shrine",
  },
  date_bazar: {
    id: `${scope}.date_bazar`,
  ...
  summerCampTitle: {
    ...
    defaultMessage:
      "Ukrainian Canadian Social Services Ottawa orginizes summer camp for displaced children from Ukraine",
  },
  summerCampContent: {
  ...
  fundraizerTitle: {
    ...
    defaultMessage:
      "Ukrainian Canadian Social Services Ottawa Branch organized a fundraiser for the summer camp",
  },
  date_lions: {
    id: `${scope}.date_lions`,
