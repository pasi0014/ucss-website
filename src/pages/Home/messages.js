...
export default defineMessages({
  ...
  embroideryText: {
    ...
    defaultMessage:
      "Experience the vibrant and rich culture of Ukraine at our upcoming Ukrainian Embroidery Cultural Event. Join us for an unforgettable evening of music and entertainment featuring a talented lineup of performers, including sound producer Gregory Dikal, The Sharms on piano, guitar, and vocals, violinist Anna Baksheeva, guitarist Andrew Mah, baritone Oleksii Fishchuk, and the Ottawa Ukrainian Children’s Choir. {br} Satisfy your appetite with delectable snacks and refreshing drinks available at our cash bar. This event promises to be a celebration of Ukrainian culture that you won't want to miss. Immerse yourself in the art of embroidery and experience the joy and enchantment of Ukrainian music and cuisine. Join us for an unforgettable night of celebration and cultural immersion.",
  },
  embroideryTitle: {
  ...
  hospitalGratiduteTitle: {
    ...
    defaultMessage: `Gratitude from all the wounded soldiers, medics and
        volunteers of the Odesa Military Medical Clinical Center`,
  },
  hospitalGratiduteTextBlurb: {
    id: `${scope}.hospitalGratiduteTextBlurb`,
