  ...
  return (
    <section className="w-full h-full body-font font-montserrat">
      <div className="sm:px-5 py-20 mx-auto">
        ...
        {/* Event Container */}
        <div className="w-full container flex sm:flex-row flex-col p-3">
          {/* Event Card */}
          <div className="sm:w-8/12 w-full">
            <div className="shadow sm:w-8/12 w-full rounded-xl mx-auto">
              <img
          ...
          <div className="w-8/12 ">
            <div className="w-8/12 rounded-xl shadow mx-auto hover:shadow-xl">
              <img
                className="w-full h-64 object-cover rounded-t-xl"
                src={vyshyvankaPic}
                alt="Event"
